...
transaction(pieceName: String, artistName: String,  recipient: Address) {
    ...
    execute {
        let newCardID = self.Administrator.mintPiece(pieceName: pieceName, artistName: artistName,  recipient: recipient)
    }
}