...
func TestFullFlow(t *testing.T) {
	...
	color.Red("Admin creates an Artist resource with the same id and it should fail")
	o.Tx("Mneme/admin/create_artist",
		...
		WithArg("communityRoyalties", "0.5"),
		WithArg("image", "https://www.johndoe.com/images/sunflowers.jpg"),
	).AssertFailure(t, `There's already an artist with this id`).Print()
	// Create a new Piece blueprint
	color.Green("Admin creates an Artist creates a Piece for the artist")
